...
| NEXT_PUBLIC_APPLE_TOUCH_ICON_URL | URL to your logo image which is used when as touch icon on Apple devices. The domain of the URL must also be configured in `next.config.js`.           | `https://guidolange.dev/og-image.png`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| NEXT_PUBLIC_SAFARI_TAB_ICON_URL  | URL for the icon used in Safari's pinned tabs. The domain of the URL must also be configured in `next.config.js`.                                      | `https://guidolange.dev/og-image.png`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
